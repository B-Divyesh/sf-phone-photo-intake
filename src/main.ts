...
function notFoundPage(): void {
  ...
  frame(`<main id="main" class="not-found"><section class="sheet"><h1 tabindex="-1">Page not found</h1><p class="lede">This address does not match a transfer, demo, privacy page, or terms page.</p><a class="button primary" href="/">Return to photo transfer</a></section></main>`);
}
